...
def loader():
    ...
    return BinanceDataLoader(backend="local", path="./test_data")
...
def loader_with_temp_dir(temp_data_dir):
    ...
    return BinanceDataLoader(backend="local", path=str(temp_data_dir))
...
class TestCheckAllFilesExist:
    ...
    def test_all_files_exist(self, temp_data_dir):
        ...
        loader = BinanceDataLoader(backend="local", path=str(temp_data_dir))
...
class TestLoaderInitialization:
    ...
    def test_default_base_path(self):
        ...
        loader = BinanceDataLoader(backend="local")
    ...
    def test_download_settings_passed_to_downloader(self, temp_data_dir):
        ...
        loader = BinanceDataLoader(
            backend="local", path=str(temp_data_dir), max_concurrent_downloads=10, retry_attempts=5, retry_delay=2
        )
